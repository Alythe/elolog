...
class LogSplitDateTimeField(fields.MultiValueField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(LogSplitDateTimeField, self).__init__(all_fields, *args, **kwargs)
    ...
    def compress(self, data_list):
        ...
        if data_list:
            ...
            input_time = strptime("%s:%s"%(data_list[1], data_list[2]), settings.TIME_FORMAT)
            datetime_string = "%s %s" % (data_list[0], strftime(settings.TIME_FORMAT, input_time))
