...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('log_comment', 'text', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Comment.text'
        db.alter_column('log_comment', 'text', self.gf('django.db.models.fields.TextField')(max_length=1000))
