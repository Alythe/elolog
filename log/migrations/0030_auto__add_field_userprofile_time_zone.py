...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('log_userprofile', 'time_zone',
                      self.gf('django.db.models.fields.CharField')(default='Europe/Vienna', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.time_zone'
        db.delete_column('log_userprofile', 'time_zone')
