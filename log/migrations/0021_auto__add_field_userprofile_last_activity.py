...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('log_userprofile', 'last_activity',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.fromtimestamp(0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_activity'
        db.delete_column('log_userprofile', 'last_activity')
    ...
    models = {
        ...
        'log.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_activity': ('django.db.models.fields.DateTimeField', [], {'default': '0'}),
