...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LogFollower.date_checked'
        db.alter_column('log_logfollower', 'date_checked', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'LogFollower.date_checked'
        db.alter_column('log_logfollower', 'date_checked', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'log.log': {
            ...
            'follower': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'logfollower'", 'symmetrical': 'False', 'through': "orm['log.LogFollower']", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'log.userprofile': {
            ...
            'logitems_per_page': ('django.db.models.fields.IntegerField', [], {'default': '20'}),
