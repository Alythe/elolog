...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LogItem.champion'
        db.delete_column('log_logitem', 'champion_id')

        # Deleting field 'LogItem.text'
        db.delete_column('log_logitem', 'text')

        # Deleting field 'LogItem.elo'
        db.delete_column('log_logitem', 'elo')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LogItem.champion'
        raise RuntimeError("Cannot reverse this migration. 'LogItem.champion' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LogItem.text'
        raise RuntimeError("Cannot reverse this migration. 'LogItem.text' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'LogItem.elo'
        raise RuntimeError("Cannot reverse this migration. 'LogItem.elo' and its values cannot be restored.")
