...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.logitems_per_page'
        db.add_column('log_userprofile', 'logitems_per_page',
                      self.gf('django.db.models.fields.IntegerField')(default=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.logitems_per_page'
        db.delete_column('log_userprofile', 'logitems_per_page')
    ...
    models = {
        ...
        'log.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_activity': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 11, 0, 0)'}),
