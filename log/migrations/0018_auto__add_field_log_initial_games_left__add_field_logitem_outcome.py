...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Log.initial_games_left'
        db.add_column('log_log', 'initial_games_left',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LogItem.outcome'
        db.add_column('log_logitem', 'outcome',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Log.initial_games_left'
        db.delete_column('log_log', 'initial_games_left')

        # Deleting field 'LogItem.outcome'
        db.delete_column('log_logitem', 'outcome')
