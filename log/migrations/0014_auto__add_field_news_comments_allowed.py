...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.comments_allowed'
        db.add_column('log_news', 'comments_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.comments_allowed'
        db.delete_column('log_news', 'comments_allowed')
