...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LogCustomField'
        db.create_table('log_logcustomfield', (
            ...
            ('display_on_overview', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('log', ['LogCustomField'])

        # Adding model 'LogCustomFieldValue'
        db.create_table('log_logcustomfieldvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('custom_field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['log.LogCustomField'])),
            ('log_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['log.LogItem'])),
            ('_value', self.gf('django.db.models.fields.TextField')(db_column='value', blank=True)),
        ))
        db.send_create_signal('log', ['LogCustomFieldValue'])


    def backwards(self, orm):
        # Deleting model 'LogCustomField'
        db.delete_table('log_logcustomfield')

        # Deleting model 'LogCustomFieldValue'
        db.delete_table('log_logcustomfieldvalue')
