...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.date_format'
        db.add_column('log_userprofile', 'date_format',
                      self.gf('django.db.models.fields.CharField')(default='%d.%m.%Y', max_length=256),
                      keep_default=False)

        # Adding field 'UserProfile.time_format'
        db.add_column('log_userprofile', 'time_format',
                      self.gf('django.db.models.fields.CharField')(default='%H:%M', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.date_format'
        db.delete_column('log_userprofile', 'date_format')

        # Deleting field 'UserProfile.time_format'
        db.delete_column('log_userprofile', 'time_format')
