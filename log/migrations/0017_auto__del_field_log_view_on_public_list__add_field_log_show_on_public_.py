...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Log.view_on_public_list'
        db.delete_column('log_log', 'view_on_public_list')

        # Adding field 'Log.show_on_public_list'
        db.add_column('log_log', 'show_on_public_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Log.view_on_public_list'
        db.add_column('log_log', 'view_on_public_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Log.show_on_public_list'
        db.delete_column('log_log', 'show_on_public_list')
