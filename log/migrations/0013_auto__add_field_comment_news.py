...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.news'
        db.add_column('log_comment', 'news',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['log.News']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.news'
        db.delete_column('log_comment', 'news_id')
