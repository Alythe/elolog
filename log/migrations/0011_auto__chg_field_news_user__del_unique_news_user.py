...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'News', fields ['user']
        db.delete_unique('log_news', ['user_id'])


        # Changing field 'News.user'
        db.alter_column('log_news', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'News.user'
        db.alter_column('log_news', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'News', fields ['user']
        db.create_unique('log_news', ['user_id'])
